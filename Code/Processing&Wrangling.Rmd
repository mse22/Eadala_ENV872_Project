...
list(unique(O_data$lakename))
list(unique(Nutrients_data$lakename))

Nutrients_data_processed <- Nutrients_data %>%
  select(-lakeid,-comments) %>%
  filter(lakename == "Paul Lake" | lakename == "Peter Lake" | lakename == "Tuesday Lake" | lakename == "Hummingbird Lake" | lakename == "Crampton Lake" | lakename == "Ward Lake") %>%
  filter(year4 == 2011 | year4 == 2012 | year4 == 2013 | year4 == 2014 | year4 == 2015 | year4 == 2016)
...
list(unique(O_data_processed$year4))
list(unique(Nutrients_data_processed$year4))
